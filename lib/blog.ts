...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "Ambele cifre pot fi discutabile. Cu cât valoarea mașinii la data accidentului este apreciată mai jos sau valoarea epavei mai sus, cu atât suma netă din dosar este mai mică, pentru că despăgubirea se calculează ca diferență între cele două. Exact aici apar cele mai frecvente diferențe între cifrele din deviz și valoarea de piață.",
      "Pentru fiecare dintre cele două cifre există un serviciu dedicat: „Evaluare Autovehicul la Data Accidentului” stabilește valoarea mașinii din ziua evenimentului, iar „Evaluare Epavă Autoturism” stabilește valoarea reziduală de piață. Ambele sunt documentate tehnic, cu referințe AUDATEX/DAT.",
      "Concluzia: nu accepta calculul daunei totale fără să verifici cele două cifre. O expertiză tehnică independentă îți arată negru pe alb cum se compune suma și cum se raportează la valoarea de piață.",
    ],
  },
  {
    ...
    body: [
      ...
      "La CarEval, fiecare raport este întocmit de Dr. Ing. Kulcsar Raul Miklos, expert tehnic judiciar autorizat de Ministerul Justiției. Când instanța numește expertul direct pe caz, expertiza are calitate deplină de expertiză judiciară.",
  ...
  {
    slug: "cum-se-calculeaza-paguba-dupa-accident",
    title: "Cum se calculează, de fapt, paguba după un accident auto",
    excerpt:
      "Suma dintr-un dosar se compune din mai multe elemente tehnice. Iată cum se calculează, cu cifre verificabile.",
    category: "Despăgubiri",
    date: "2026-05-20",
    readingTime: "4 min",
    body: [
      "După un accident, prima ofertă este de cele mai multe ori construită pe estimări rapide, sub valoarea de piață a pagubei. Asta nu înseamnă că e ceva ilegal, ci că estimările inițiale tind să fie prudente și pornesc de la cifre standard, nu de la situația concretă a mașinii tale.",
      "Pentru a ști exact cum se compune valoarea, ai nevoie de trei cifre: valoarea de piață a mașinii, costul real al reparației (calculat în AUDATEX sau DAT) și, în cazul daunei totale, valoarea epavei.",
      "Un raport de evaluare independent îți pune aceste cifre negru pe alb. Cu el, poți contesta o ofertă subevaluată și poți susține, cu argumente tehnice, valoarea de piață a pagubei.",
      "Concluzia e simplă: nu accepta prima ofertă fără să verifici. O expertiză tehnică autorizată costă puțin în comparație cu diferența pe care o poți documenta.",
    ],
  },
  {
    slug: "ce-este-devalorizarea-auto",
    title: "Ce este devalorizarea auto și cum se documentează",
    excerpt:
      "Chiar reparată impecabil, o mașină accidentată valorează mai puțin. Această pierdere poate fi calculată și documentată tehnic.",
    category: "Ghid",
    date: "2026-04-28",
    readingTime: "3 min",
    body: [
  ...
  /* ═══ Articole SEO de nișă (cluster despăgubiri) ═══ */
  {
    ...
    excerpt: "Dacă vrei să verifici dacă suma din dosar este corectă, un raport tehnic îți arată cum se compune valoarea. Iată de unde apar diferențele și cum le poți documenta tehnic.",
    category: "Despăgubiri",
    date: "2026-01-14",
    readingTime: "5 min",
    body: [
      ...
      "Dacă vrei să verifici suma din dosar, cere o evaluare tehnică a prejudiciului. În 24 până la 48 de ore primești un document tehnic clar, 100% online, cu care poți intra în discuție de pe o poziție informată, nu defensivă.",
    ],
  },
  {
    ...
    readingTime: "6 min",
    body: [
      "O ofertă de despăgubire nu este o sentință definitivă, este o propunere. Mulți oameni o acceptă din grabă sau din senzația că nu au ce face, apoi regretă. Vestea bună este că există o procedură logică prin care poți contesta, iar dacă o urmezi ordonat, șansele ca recalcularea să reflecte corect dauna cresc semnificativ.",
      "Primul pas este să soliciți devizul complet, nu doar suma finală. Ceri în scris, pe email, defalcarea: piese, manoperă, vopsitorie, operațiuni conexe. Fără acest document nu poți argumenta nimic, pentru că nu știi unde s-a tăiat. Al doilea pas este să compari devizul cu realitatea tehnică a reparației, iar aici un ochi de specialist face diferența între o bănuială și un argument.",
      "Al treilea pas este documentarea stării mașinii: fotografii clare ale avariilor, din unghiuri multiple, plus documentele vehiculului și eventualele facturi de întreținere care dovedesc starea bună. Cu cât dosarul tău este mai complet, cu atât contestația ta este mai greu de respins printr-un simplu răspuns formal.",
      "Al patrulea pas, și cel care schimbă echilibrul, este o contraexpertiză tehnică. Aceasta reia calculul în sistemele AUDATEX sau DAT și produce un deviz alternativ, argumentat poziție cu poziție. Nu spune doar că suma este mică, ci arată exact ce operațiuni lipsesc și de ce valoarea corectă se situează într-un alt interval orientativ. Un astfel de document devine o bază de discuție solidă tocmai pentru că vorbește limbajul lor tehnic.",
  ...
  },
  {
    ...
    body: [
      ...
      "Dacă ai unul dintre semnalele de mai sus, nu aștepta. Cere o evaluare tehnică a prejudiciului de la CarEval, 100% online, cu livrare în 24 până la 48 de ore, și află care este cifra documentată tehnic în cazul tău.",
    ],
  },
  {
    ...
    body: [
      ...
      "Nu lăsa diferența dintre RCA și CASCO să te ia prin surprindere din necunoaștere. Comandă o Contraexpertiză Tehnică de la CarEval și află, punct cu punct, dacă despăgubirea ta reflectă corect dauna, indiferent de tipul asigurării.",
    ],
  },
  {
    slug: "ce-faci-cand-plata-despagubirii-intarzie",
    title: "Ce faci când plata despăgubirii întârzie: pași și termene",
    excerpt: "Plata întârzie, răspunsul lipsește sau ți se cer mereu alte documente. Iată pașii concreți și de ce termenul de contestație nu trebuie lăsat să treacă.",
    category: "Despăgubiri",
    date: "2026-05-20",
    readingTime: "6 min",
    body: [
      "Puține situații sunt mai frustrante decât un dosar de daună care rămâne blocat: fie primești un răspuns negativ fără explicații, fie ți se cer mereu alte documente, fie pur și simplu nu mai primești răspuns. Este o formă de uzură psihologică, iar mulți oameni renunță tocmai pentru că se simt depășiți. Nu trebuie să fie așa, dacă acționezi ordonat și la timp.",
      "Primul principiu: totul în scris. Solicitările tale, răspunsurile primite, cererile de documente, toate trebuie să existe pe email sau pe hârtie, cu date. Un dosar în care comunicarea a fost doar telefonică este un dosar greu de apărat. Al doilea principiu: cere motivarea. Când plata întârzie, ai dreptul la o justificare scrisă și la termene clare, iar un răspuns nemotivat sau vag este exact tipul de răspuns pe care îl poți contesta.",
      "Al doilea pas practic este să îți consolidezi dosarul tehnic. Dacă întârzierea se sprijină pe ideea că avaria nu justifică suma cerută, o expertiză tehnică independentă răstoarnă discuția. Calculată în sistemele AUDATEX sau DAT, ea arată exact ce operațiuni și piese sunt necesare și produce o cifră documentată tehnic. Un astfel de document este mult mai greu de ignorat decât o simplă cerere de plată.",
      ...
      "Dacă plata despăgubirii întârzie, nu rămâne pe poziție de așteptare. Comandă o Contraexpertiză Tehnică de la CarEval, 100% online, cu livrare în 24 până la 48 de ore, și transformă un dosar blocat într-un dosar documentat, cu argumente pe care cealaltă parte le poate verifica.",
    ],
  },
  ...
  /* ═══ Articole SEO de nișă (cluster daună totală / epavă) ═══ */
  {
    ...
    body: [
      ...
      "Aici intervine avantajul unei evaluări independente. Un raport care pornește de la starea concretă a mașinii tale, nu de la o medie generică, îți oferă o bază solidă în discuția cu asigurătorul și un argument tehnic puternic atunci când cifrele nu se potrivesc.",
  ...
  },
  {
    ...
    body: [
      ...
      "Un raport independent care stabilește corect valoarea la momentul evenimentului îți arată dacă încadrarea este justificată și îți oferă un argument tehnic puternic atunci când ai motive să crezi că estimarea inițială te dezavantajează.",
  ...
  },
  {
    ...
    body: [
      ...
      "Când cifrele propuse nu se potrivesc cu realitatea, un raport independent devine instrumentul tău principal. Devine un punct de referință solid și îți dă o poziție clară în negociere, fără să te bazezi doar pe estimarea celeilalte părți.",
      "Dacă vrei să te asiguri că suma finală reflectă valoarea de piață a mașinii tale, serviciul de Evaluare Autovehicul la Data Accidentului, completat la nevoie de Evaluare Epavă Autoturism, îți oferă cifrele documentate de care ai nevoie, complet online, în 24 până la 48 de ore.",
    ],
  },
  ...
  /* ═══ Articole SEO de nișă (cluster devalorizare / contraexpertiză / pre-cumpărare) ═══ */
  {
    ...
    body: [
      ...
      "Trebuie spus onest că estimarea noastră este o opinie tehnică, nu o garanție că vei primi exact acea sumă. Rolul nostru este să îți dăm un argument solid și coerent, care rezistă la o discuție serioasă și care poate deveni un punct de plecare rezonabil în negocierea cu asigurătorul. Decizia finală asupra despăgubirii rămâne un proces de negociere sau, dacă se ajunge acolo, o chestiune pentru instanță.",
      "Dacă tocmai ți-ai reparat mașina după un accident și simți că oferta primită nu ține cont de pierderea reală de valoare, o Evaluare Devalorizare la CarEval îți oferă baza tehnică de care ai nevoie pentru a susține discuția, calm și pe argumente, nu pe presupuneri.",
    ],
  },
  {
