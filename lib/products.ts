...
export const products: Product[] = [
  {
    id: 1,
    slug: "evaluare-autovehicul",
    code: "EV1",
    name: "Evaluare Autovehicul",
    tagline: "Află valoarea reală de piață înainte să cumperi sau să vinzi.",
    price: 320,
    delivery: "24–48h",
    ...
    popular: true,
    shortDescription:
      "Raport autorizat cu valoarea de piață a mașinii — date tehnice complete, dotări și preț corect, semnat de expert tehnic judiciar.",
    description: [
      "Vrei să cumperi sau să vinzi o mașină și nu știi cât valorează cu adevărat? Raportul de Evaluare Autovehicul îți oferă valoarea de piață corectă, calculată profesionist.",
      "Raportul conține datele tehnice complete, lista de dotări și valoarea de piață, fiind o expertiză tehnică cu valoare legală, semnată de expert tehnic judiciar autorizat de Ministerul Justiției.",
    ],
    benefits: [
      "Valoare de piață corectă, nu o estimare la nas",
      "Raport PDF autorizat, acceptat oficial",
      "Util la vânzare, cumpărare, partaj sau leasing",
    ],
    steps: [stepVehicle(), { id: "imagini", title: "Imagini cu mașina", subtitle: "Câte o poză clară din fiecare unghi.", images: angleImages }, contactStep],
  },
  {
    id: 2,
    ...
    price: 490,
    delivery: "24–48h",
    image: "/images/evaluare-costuri-reparatie-autovehicul-884671.png",
    category: "Accident",
    shortDescription:
  ...
  },
  {
    ...
    price: 320,
    delivery: "24–48h",
    image: "/images/evaluare-autovehicul-la-data-accidentului-961585.webp",
    category: "Accident",
    shortDescription:
      "Stabilește valoarea de piață a vehiculului la data accidentului — esențial pentru daune totale și despăgubiri corecte.",
    description: [
      "Când mașina e daună totală, asigurătorul te despăgubește la valoarea ei din ziua accidentului. Acest raport stabilește exact acea valoare, pe baza pieței din acel moment.",
      "Expertiza tehnică judiciară îți oferă o cifră corectă și documentată, pe care o poți susține oficial.",
    ],
    benefits: [
      "Valoare raportată la data exactă a accidentului",
  ...
  },
  {
    ...
    price: 650,
    delivery: "24–48h",
    image: "/images/evaluare-despagubiri-cuvenite-796407.webp",
    category: "Accident",
    popular: true,
    shortDescription:
    ...
    description: [
      ...
      "Combinăm valoarea de piață, devizul de reparație și prevederile legale într-un singur document de expertiză, cu care poți contesta o ofertă subevaluată.",
    ],
    benefits: [
      "Suma corectă, calculată legal",
      "Bază pentru contestație sau instanță",
      "Întocmit de expert tehnic judiciar",
    ],
  ...
  },
  {
    ...
    price: 450,
    delivery: "24–48h",
    image: "/images/evaluare-epava-autoturism-452221.webp",
    category: "Accident",
    shortDescription:
  ...
  },
  {
    ...
    price: 1200,
    delivery: "24–48h",
    image: "/images/evaluare-devalorizare-autovehicul-dupa-accident-384529.png",
    category: "Accident",
    shortDescription:
    ...
    description: [
      ...
      "Raportul calculează exact procentul și suma devalorizării, fiind documentul cu care îți ceri banii pierduți de la partea vinovată sau asigurător.",
    ],
    benefits: [
      "Recuperezi valoarea pierdută la revânzare",
      "Calcul procentual documentat",
  ...
  },
  {
    ...
    image: "/images/consultanta-in-caz-de-accident-606927.webp",
